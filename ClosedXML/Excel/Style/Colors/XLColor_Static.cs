...
namespace ClosedXML.Excel
{
    public partial class XLColor
    {
        ...
        public static Dictionary<string, Color> KnownColors = new Dictionary<string, Color>();
        ...
        {
            return FromColor(new Color((uint) argb));
        }

        public static XLColor FromArgb(Int32 r, Int32 g, Int32 b)
        {
            return FromColor(new Color((byte) r, (byte) g, (byte) b));
        }

        public static XLColor FromArgb(Int32 a, Int32 r, Int32 g, Int32 b)
        {
            return FromColor(new Color((byte) r, (byte) g, (byte) b, (byte) a));
        }
        ...
        public static XLColor FromName(String name)
        {
            ...
            {
                KnownColors = typeof(Colors)
                .GetFields(BindingFlags.Static | BindingFlags.Public)
                .Select(fld => new {Color = (Color) fld.GetValue(null), fld.Name})
                .ToDictionary(x => x.Name, y => y.Color);
            }
            return KnownColors.TryGetValue(name, out Color value) ? FromColor(value) : Black;
        }
            ...
            get
            {
                if (_indexedColors == null)
                {
                    var retVal = new Dictionary<Int32, XLColor>
                    {
                        ...
                        {64, FromColor(Colors.Transparent)}
                    };
        ...
        {
            get { return FromColor(Colors.AliceBlue); }
        }

        public static XLColor AntiqueWhite
        {
            get { return FromColor(Colors.AntiqueWhite); }
        }

        public static XLColor Aqua
        {
            get { return FromColor(Colors.Aqua); }
        }

        public static XLColor Aquamarine
        {
            get { return FromColor(Colors.Aquamarine); }
        }

        public static XLColor Azure
        {
            get { return FromColor(Colors.Azure); }
        }

        public static XLColor Beige
        {
            get { return FromColor(Colors.Beige); }
        }

        public static XLColor Bisque
        {
            get { return FromColor(Colors.Bisque); }
        }

        public static XLColor Black
        {
            get { return FromColor(Colors.Black); }
        }

        public static XLColor BlanchedAlmond
        {
            get { return FromColor(Colors.BlanchedAlmond); }
        }

        public static XLColor Blue
        {
            get { return FromColor(Colors.Blue); }
        }

        public static XLColor BlueViolet
        {
            get { return FromColor(Colors.BlueViolet); }
        }

        public static XLColor Brown
        {
            get { return FromColor(Colors.Brown); }
        }

        public static XLColor BurlyWood
        {
            get { return FromColor(Colors.BurlyWood); }
        }

        public static XLColor CadetBlue
        {
            get { return FromColor(Colors.CadetBlue); }
        }

        public static XLColor Chartreuse
        {
            get { return FromColor(Colors.Chartreuse); }
        }

        public static XLColor Chocolate
        {
            get { return FromColor(Colors.Chocolate); }
        }

        public static XLColor Coral
        {
            get { return FromColor(Colors.Coral); }
        }

        public static XLColor CornflowerBlue
        {
            get { return FromColor(Colors.CornflowerBlue); }
        }

        public static XLColor Cornsilk
        {
            get { return FromColor(Colors.Cornsilk); }
        }

        public static XLColor Crimson
        {
            get { return FromColor(Colors.Crimson); }
        }

        public static XLColor Cyan
        {
            get { return FromColor(Colors.Cyan); }
        }

        public static XLColor DarkBlue
        {
            get { return FromColor(Colors.DarkBlue); }
        }

        public static XLColor DarkCyan
        {
            get { return FromColor(Colors.DarkCyan); }
        }

        public static XLColor DarkGoldenrod
        {
            get { return FromColor(Colors.DarkGoldenrod); }
        }

        public static XLColor DarkGray
        {
            get { return FromColor(Colors.DarkGray); }
        }

        public static XLColor DarkGreen
        {
            get { return FromColor(Colors.DarkGreen); }
        }

        public static XLColor DarkKhaki
        {
            get { return FromColor(Colors.DarkKhaki); }
        }

        public static XLColor DarkMagenta
        {
            get { return FromColor(Colors.DarkMagenta); }
        }

        public static XLColor DarkOliveGreen
        {
            get { return FromColor(Colors.DarkOliveGreen); }
        }

        public static XLColor DarkOrange
        {
            get { return FromColor(Colors.DarkOrange); }
        }

        public static XLColor DarkOrchid
        {
            get { return FromColor(Colors.DarkOrchid); }
        }

        public static XLColor DarkRed
        {
            get { return FromColor(Colors.DarkRed); }
        }

        public static XLColor DarkSalmon
        {
            get { return FromColor(Colors.DarkSalmon); }
        }

        public static XLColor DarkSeaGreen
        {
            get { return FromColor(Colors.DarkSeaGreen); }
        }

        public static XLColor DarkSlateBlue
        {
            get { return FromColor(Colors.DarkSlateBlue); }
        }

        public static XLColor DarkSlateGray
        {
            get { return FromColor(Colors.DarkSlateGray); }
        }

        public static XLColor DarkTurquoise
        {
            get { return FromColor(Colors.DarkTurquoise); }
        }

        public static XLColor DarkViolet
        {
            get { return FromColor(Colors.DarkViolet); }
        }

        public static XLColor DeepPink
        {
            get { return FromColor(Colors.DeepPink); }
        }

        public static XLColor DeepSkyBlue
        {
            get { return FromColor(Colors.DeepSkyBlue); }
        }

        public static XLColor DimGray
        {
            get { return FromColor(Colors.DimGray); }
        }

        public static XLColor DodgerBlue
        {
            get { return FromColor(Colors.DodgerBlue); }
        }

        public static XLColor Firebrick
        {
            get { return FromColor(Colors.Firebrick); }
        }

        public static XLColor FloralWhite
        {
            get { return FromColor(Colors.FloralWhite); }
        }

        public static XLColor ForestGreen
        {
            get { return FromColor(Colors.ForestGreen); }
        }

        public static XLColor Fuchsia
        {
            get { return FromColor(Colors.Fuchsia); }
        }

        public static XLColor Gainsboro
        {
            get { return FromColor(Colors.Gainsboro); }
        }

        public static XLColor GhostWhite
        {
            get { return FromColor(Colors.GhostWhite); }
        }

        public static XLColor Gold
        {
            get { return FromColor(Colors.Gold); }
        }

        public static XLColor Goldenrod
        {
            get { return FromColor(Colors.Goldenrod); }
        }

        public static XLColor Gray
        {
            get { return FromColor(Colors.Gray); }
        }

        public static XLColor Green
        {
            get { return FromColor(Colors.Green); }
        }

        public static XLColor GreenYellow
        {
            get { return FromColor(Colors.GreenYellow); }
        }

        public static XLColor Honeydew
        {
            get { return FromColor(Colors.Honeydew); }
        }

        public static XLColor HotPink
        {
            get { return FromColor(Colors.HotPink); }
        }

        public static XLColor IndianRed
        {
            get { return FromColor(Colors.IndianRed); }
        }

        public static XLColor Indigo
        {
            get { return FromColor(Colors.Indigo); }
        }

        public static XLColor Ivory
        {
            get { return FromColor(Colors.Ivory); }
        }

        public static XLColor Khaki
        {
            get { return FromColor(Colors.Khaki); }
        }

        public static XLColor Lavender
        {
            get { return FromColor(Colors.Lavender); }
        }

        public static XLColor LavenderBlush
        {
            get { return FromColor(Colors.LavenderBlush); }
        }

        public static XLColor LawnGreen
        {
            get { return FromColor(Colors.LawnGreen); }
        }

        public static XLColor LemonChiffon
        {
            get { return FromColor(Colors.LemonChiffon); }
        }

        public static XLColor LightBlue
        {
            get { return FromColor(Colors.LightBlue); }
        }

        public static XLColor LightCoral
        {
            get { return FromColor(Colors.LightCoral); }
        }

        public static XLColor LightCyan
        {
            get { return FromColor(Colors.LightCyan); }
        }

        public static XLColor LightGoldenrodYellow
        {
            get { return FromColor(Colors.LightGoldenrodYellow); }
        }

        public static XLColor LightGray
        {
            get { return FromColor(Colors.LightGray); }
        }

        public static XLColor LightGreen
        {
            get { return FromColor(Colors.LightGreen); }
        }

        public static XLColor LightPink
        {
            get { return FromColor(Colors.LightPink); }
        }

        public static XLColor LightSalmon
        {
            get { return FromColor(Colors.LightSalmon); }
        }

        public static XLColor LightSeaGreen
        {
            get { return FromColor(Colors.LightSeaGreen); }
        }

        public static XLColor LightSkyBlue
        {
            get { return FromColor(Colors.LightSkyBlue); }
        }

        public static XLColor LightSlateGray
        {
            get { return FromColor(Colors.LightSlateGray); }
        }

        public static XLColor LightSteelBlue
        {
            get { return FromColor(Colors.LightSteelBlue); }
        }

        public static XLColor LightYellow
        {
            get { return FromColor(Colors.LightYellow); }
        }

        public static XLColor Lime
        {
            get { return FromColor(Colors.Lime); }
        }

        public static XLColor LimeGreen
        {
            get { return FromColor(Colors.LimeGreen); }
        }

        public static XLColor Linen
        {
            get { return FromColor(Colors.Linen); }
        }

        public static XLColor Magenta
        {
            get { return FromColor(Colors.Magenta); }
        }

        public static XLColor Maroon
        {
            get { return FromColor(Colors.Maroon); }
        }

        public static XLColor MediumAquamarine
        {
            get { return FromColor(Colors.MediumAquamarine); }
        }

        public static XLColor MediumBlue
        {
            get { return FromColor(Colors.MediumBlue); }
        }

        public static XLColor MediumOrchid
        {
            get { return FromColor(Colors.MediumOrchid); }
        }

        public static XLColor MediumPurple
        {
            get { return FromColor(Colors.MediumPurple); }
        }

        public static XLColor MediumSeaGreen
        {
            get { return FromColor(Colors.MediumSeaGreen); }
        }

        public static XLColor MediumSlateBlue
        {
            get { return FromColor(Colors.MediumSlateBlue); }
        }

        public static XLColor MediumSpringGreen
        {
            get { return FromColor(Colors.MediumSpringGreen); }
        }

        public static XLColor MediumTurquoise
        {
            get { return FromColor(Colors.MediumTurquoise); }
        }

        public static XLColor MediumVioletRed
        {
            get { return FromColor(Colors.MediumVioletRed); }
        }

        public static XLColor MidnightBlue
        {
            get { return FromColor(Colors.MidnightBlue); }
        }

        public static XLColor MintCream
        {
            get { return FromColor(Colors.MintCream); }
        }

        public static XLColor MistyRose
        {
            get { return FromColor(Colors.MistyRose); }
        }

        public static XLColor Moccasin
        {
            get { return FromColor(Colors.Moccasin); }
        }

        public static XLColor NavajoWhite
        {
            get { return FromColor(Colors.NavajoWhite); }
        }

        public static XLColor Navy
        {
            get { return FromColor(Colors.Navy); }
        }

        public static XLColor OldLace
        {
            get { return FromColor(Colors.OldLace); }
        }

        public static XLColor Olive
        {
            get { return FromColor(Colors.Olive); }
        }

        public static XLColor OliveDrab
        {
            get { return FromColor(Colors.OliveDrab); }
        }

        public static XLColor Orange
        {
            get { return FromColor(Colors.Orange); }
        }

        public static XLColor OrangeRed
        {
            get { return FromColor(Colors.OrangeRed); }
        }

        public static XLColor Orchid
        {
            get { return FromColor(Colors.Orchid); }
        }

        public static XLColor PaleGoldenrod
        {
            get { return FromColor(Colors.PaleGoldenrod); }
        }

        public static XLColor PaleGreen
        {
            get { return FromColor(Colors.PaleGreen); }
        }

        public static XLColor PaleTurquoise
        {
            get { return FromColor(Colors.PaleTurquoise); }
        }

        public static XLColor PaleVioletRed
        {
            get { return FromColor(Colors.PaleVioletRed); }
        }

        public static XLColor PapayaWhip
        {
            get { return FromColor(Colors.PapayaWhip); }
        }

        public static XLColor PeachPuff
        {
            get { return FromColor(Colors.PeachPuff); }
        }

        public static XLColor Peru
        {
            get { return FromColor(Colors.Peru); }
        }

        public static XLColor Pink
        {
            get { return FromColor(Colors.Pink); }
        }

        public static XLColor Plum
        {
            get { return FromColor(Colors.Plum); }
        }

        public static XLColor PowderBlue
        {
            get { return FromColor(Colors.PowderBlue); }
        }

        public static XLColor Purple
        {
            get { return FromColor(Colors.Purple); }
        }

        public static XLColor Red
        {
            get { return FromColor(Colors.Red); }
        }

        public static XLColor RosyBrown
        {
            get { return FromColor(Colors.RosyBrown); }
        }

        public static XLColor RoyalBlue
        {
            get { return FromColor(Colors.RoyalBlue); }
        }

        public static XLColor SaddleBrown
        {
            get { return FromColor(Colors.SaddleBrown); }
        }

        public static XLColor Salmon
        {
            get { return FromColor(Colors.Salmon); }
        }

        public static XLColor SandyBrown
        {
            get { return FromColor(Colors.SandyBrown); }
        }

        public static XLColor SeaGreen
        {
            get { return FromColor(Colors.SeaGreen); }
        }

        public static XLColor SeaShell
        {
            get { return FromColor(Colors.SeaShell); }
        }

        public static XLColor Sienna
        {
            get { return FromColor(Colors.Sienna); }
        }

        public static XLColor Silver
        {
            get { return FromColor(Colors.Silver); }
        }

        public static XLColor SkyBlue
        {
            get { return FromColor(Colors.SkyBlue); }
        }

        public static XLColor SlateBlue
        {
            get { return FromColor(Colors.SlateBlue); }
        }

        public static XLColor SlateGray
        {
            get { return FromColor(Colors.SlateGray); }
        }

        public static XLColor Snow
        {
            get { return FromColor(Colors.Snow); }
        }

        public static XLColor SpringGreen
        {
            get { return FromColor(Colors.SpringGreen); }
        }

        public static XLColor SteelBlue
        {
            get { return FromColor(Colors.SteelBlue); }
        }

        public static XLColor Tan
        {
            get { return FromColor(Colors.Tan); }
        }

        public static XLColor Teal
        {
            get { return FromColor(Colors.Teal); }
        }

        public static XLColor Thistle
        {
            get { return FromColor(Colors.Thistle); }
        }

        public static XLColor Tomato
        {
            get { return FromColor(Colors.Tomato); }
        }

        public static XLColor Turquoise
        {
            get { return FromColor(Colors.Turquoise); }
        }

        public static XLColor Violet
        {
            get { return FromColor(Colors.Violet); }
        }

        public static XLColor Wheat
        {
            get { return FromColor(Colors.Wheat); }
        }

        public static XLColor White
        {
            get { return FromColor(Colors.White); }
        }

        public static XLColor WhiteSmoke
        {
            get { return FromColor(Colors.WhiteSmoke); }
        }

        public static XLColor Yellow
        {
            get { return FromColor(Colors.Yellow); }
        }

        public static XLColor YellowGreen
        {
            get { return FromColor(Colors.YellowGreen); }
        }
        ...
        {
            get { return FromHtml("#FFEDC9AF"); }
        }

        public static XLColor DogwoodRose
        {
            get { return FromHtml("#FFD71868"); }
        }

        public static XLColor DollarBill
        {
            get { return FromHtml("#FF85BB65"); }
        }

        public static XLColor Drab
        {
            get { return FromHtml("#FF967117"); }
        }

        public static XLColor DukeBlue
        {
            get { return FromHtml("#FF00009C"); }
        }

        public static XLColor EarthYellow
        {
            get { return FromHtml("#FFE1A95F"); }
        }
        ...
        {
            get { return FromHtml("#FF3FFF00"); }
        }

        public static XLColor HarvardCrimson
        {
            get { return FromHtml("#FFC90016"); }
        }

        public static XLColor HarvestGold
        {
            get { return FromHtml("#FFDA9100"); }
        }

        public static XLColor Heliotrope
        {
            get { return FromHtml("#FFDF73FF"); }
        }
        ...
        {
            get { return FromHtml("#FF414833"); }
        }

        public static XLColor RobinEggBlue
        {
            get { return FromHtml("#FF00CCCC"); }
        }
        ...
        {
            get { return FromHtml("#FFF9429E"); }
        }

        public static XLColor RoseEbony
        {
            get { return FromHtml("#FF674846"); }
        }

        public static XLColor RoseGold
        {
            get { return FromHtml("#FFB76E79"); }
        }
        ...
        {
            get { return FromHtml("#FFFF66CC"); }
        }

        public static XLColor RoseQuartz
        {
            get { return FromHtml("#FFAA98A9"); }
        }

        public static XLColor RoseTaupe
        {
            get { return FromHtml("#FF905D5D"); }
        }
        ...
        {
            get { return FromHtml("#FFE4D96F"); }
        }

        public static XLColor Sunglow
        {
            get { return FromHtml("#FFFFCC33"); }
        }
        ...
        {
            get { return FromHtml("#FFF94D00"); }
        }

        public static XLColor Tangerine
        {
            get { return FromHtml("#FFF28500"); }
        }

        public static XLColor TangerineYellow
        {
            get { return FromHtml("#FFFFCC00"); }
        }
        ...
        {
            get { return FromHtml("#FF8B8589"); }
        }

        public static XLColor TeaGreen
        {
            get { return FromHtml("#FFD0F0C0"); }
        }

        public static XLColor TealBlue
        {
            get { return FromHtml("#FF367588"); }
        }

        public static XLColor TealGreen
        {
            get { return FromHtml("#FF006D5B"); }
        }
        ...
        {
            get { return FromHtml("#FF7B1113"); }
        }

        public static XLColor UpsdellRed
        {
            get { return FromHtml("#FFAE2029"); }
        }

        public static XLColor Urobilin
        {
            get { return FromHtml("#FFE1AD21"); }
        }
        ...
        {
            get { return FromHtml("#FFC5B358"); }
        }

        public static XLColor VenetianRed
        {
            get { return FromHtml("#FFC80815"); }
        }

        public static XLColor Verdigris
        {
            get { return FromHtml("#FF43B3AE"); }
        }
        ...
        {
            get { return FromHtml("#FFEFCC00"); }
        }

        public static XLColor YellowNcs
        {
            get { return FromHtml("#FFFFD300"); }
        }
        ...
        {
            get { return FromHtml("#FFFEFE33"); }
        }

        public static XLColor Zaffre
        {
            get { return FromHtml("#FF0014A8"); }
        }
        ...
        {
            get { return FromColor(Colors.Transparent); }
        }
    }
}
