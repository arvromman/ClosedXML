...
namespace ClosedXML.Tests
{
    ...
    public class CopyingRangesTests
    {
        ...
        public void CopyingColumns()
        {
            ...
            column1.Cell(5).Style.Fill.SetBackgroundColor(XLColor.FromColor(Colors.MediumSeaGreen));
            ...
            Assert.AreEqual(XLColor.FromColor(Colors.MediumSeaGreen),
        ...
        public void CopyingRows()
        {
            ...
            Assert.AreEqual(XLColor.FromColor(Colors.MediumSeaGreen), row2.Cell(5).Style.Fill.BackgroundColor);
            ...
            Assert.AreEqual(XLColor.FromColor(Colors.MediumSeaGreen), row3.Cell(5).Style.Fill.BackgroundColor);
        ...
        private static void FillRow(IXLRow row1)
        {
            ...
            row1.Cell(5).Style.Fill.SetBackgroundColor(XLColor.FromColor(Colors.MediumSeaGreen));
